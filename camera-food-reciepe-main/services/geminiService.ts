...
import { fetchVideoTranscript } from './videoTranscriptService';
import type { TranscriptSegment, TranscriptFetchResult } from './videoTranscriptService';
...
4. 응답은 JSON 배열 형식만 반환하세요.`;
    ...
    try {
        ...
        const { chunks: transcriptChunks, promptStatus } = resolveTranscriptStatus(transcriptResult, transcriptError);
