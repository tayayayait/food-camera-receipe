...
export const heroSectionHowItWorksStep1 = '가지고 있는 재료를 촬영해 인식하세요.';
...
export const pantrySectionTitle = '카메라가 인식한 재료 목록';
export const pantrySectionDescription = '스캔할 때마다 이 목록이 새로고침되어 어떤 재료가 감지되었는지 바로 확인할 수 있어요.';
...
export const pantryManualInputCount = '현재 입력된 재료 {{count}}개';
...
export const nutritionContextRecipeNote = '선택한 레시피 기준으로 추정했어요.';
...
export const nutritionCardDetectedLabel = '감지·입력된 재료 ({{count}}개)';
...
export const toolbarNutrition = '영양';
export const toolbarNutritionHint = '영양 요약';
...
export const logbookFormTitlePlaceholder = '예: 주말 라구 준비';
export const logbookFormRecipeLabel = '레시피 이름';
export const logbookFormRecipePlaceholder = '예: 할머니 토마토 소스';
export const logbookFormNotesLabel = '메모';
export const logbookFormNotesPlaceholder = '만들면서 배운 점이나 다음에 개선하고 싶은 점을 적어보세요.';
export const logbookFormAddButton = '기록 추가';
export const logbookEmptyState = '아직 기록이 없어요. 바로 위에서 첫 번째 기록을 작성해보세요!';
...
export const journalSelectedVideoLabel = '선택한 영상: {{title}}';
export const journalRewatchVideo = '영상 다시 보기';
export const journalViewNutrition = '영양 정보 보기';
